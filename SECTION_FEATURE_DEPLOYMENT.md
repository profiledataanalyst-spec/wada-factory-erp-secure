# Factory ERP v11.1 — Section Feature Deployment
...
6. After deployment, open `/api/config` and confirm `applicationVersion` is `11.1.0`.
...
3. Confirm a blank Section from an older workbook is accepted and shown as `Not Specified`.
